...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'proposal_submitted.create': { roles: ['admin', 'recruiter'], key: 'proposal', tenantPath: [], userPath: [] },
  'freelancer_shortlisted.update': { roles: ['admin', 'recruiter'], key: 'shortlist', tenantPath: [], userPath: [] },
  'proposal_approved.update': { roles: ['admin', 'recruiter'], key: 'approval', tenantPath: [], userPath: [] },
};
