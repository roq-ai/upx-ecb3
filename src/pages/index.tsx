  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Upx: Bridging the Gap Between Companies and Freelancers. Post Jobs, Apply, Collaborate, and Achieve Success Together in Our Marketplace."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Upx: Bridging the Gap Between Companies and Freelancers. Post Jobs, Apply, Collaborate, and Achieve Success Together in Our Marketplace.`}
            </Text>
            <Box
